...
public class ViewMyAuditService {
	...
	public void login(WebDriver driver, String roleName, String workId) {
		Select selectRoleName = new Select(
						driver.findElement(By.id("roleName")));
		selectRoleName.selectByValue(roleName);

		Select selectUser = new Select(driver.findElement(By.id("staff")));
		selectUser.selectByValue(workId);
		...
		snapshot("pa_test_case_0101_login.png", driver);
	}

	public void myAudit(WebDriver driver, String projectName) {
		...
		snapshot("pa_test_case_0201_my_audit.png", driver);
		// 绝对匹配
		driver.findElement(By.xpath("//span[text()='" + projectName + "']"))
						.click();

		snapshot("pa_test_case_0202_my_audit.png", driver);
	}

	public void enterToAddAuditPage(WebDriver driver, String typeName) {
		// 链接文字
